...
export const CONTRAST_THEMES: Record<ContrastThemeId, ContrastThemeConfig> = {
  ...
  'ciano-neon': {
    ...
    bgStickyHeader: 'bg-[#071720]/98 backdrop-blur-md',
    borderStickyHeader: 'border-cyan-400',
    bgAccessibility: 'bg-[#071720] text-cyan-200',
    borderAccessibility: 'border-cyan-400/80',
    titleColor: 'text-cyan-300 drop-shadow-[0_2px_12px_rgba(6,182,212,0.6)] font-black',
    accentBar: 'bg-cyan-400 shadow-[0_0_8px_rgba(6,182,212,0.8)]',
    bgCard: 'bg-[#0b1f2a]',
  ...
  'verde-lima': {
    ...
    bgStickyHeader: 'bg-[#0e1b06]/98 backdrop-blur-md',
    borderStickyHeader: 'border-lime-400',
    bgAccessibility: 'bg-[#0e1b06] text-lime-200',
    borderAccessibility: 'border-lime-400/80',
    titleColor: 'text-lime-400 drop-shadow-[0_2px_12px_rgba(163,230,53,0.6)] font-black',
    accentBar: 'bg-lime-400 shadow-[0_0_8px_rgba(163,230,53,0.8)]',
    bgCard: 'bg-[#142609]',
